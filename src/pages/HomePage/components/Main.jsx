    ...
    <div className="flex flex-col md:flex-row justify-between gap-10">
      <section className="flex flex-col gap-5 w-full md:w-[50%]">
        ...
        <div className="flex gap-3">
          <Link to="/dashboard" className="flex gap-2 bg-white rounded-md text-black justify-center items-center  py-3 px-4 text-sm font-semibold">
            <span>Get Started Free</span>
            <FaArrowRight />
          </Link>
          <Link to="/dashboard" className="px-4 py-3 bg-black text-white text-sm border-1 border-gray-700 rounded-md font-semibold">Learn More </Link>
        </div>
      </section>
